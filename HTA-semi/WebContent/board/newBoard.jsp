	...
	<table class="table table-hover">
		...
		<tr>
			...
			<td><input type="text" name="price" id="price"
				value="${ vo.getStartprice() }"></td>
		</tr>
		<tr>
			<th>시작날짜</th>
			<td><input type="text" id="sdate" name="sdate" value="${day}"></td>
		</tr>
		<tr>
			<th>시작시간선택</th>
			<td>
			...
			<select id="hh" name="hh" class="form-control">
			...
			</select><label for="mm">분</label>
			</div>
			</td>
		</tr>
		<tr>
			<th>이미지</th>
			<td><input type="file" name="orgfile" id="orgfile"
				value="${vo.getOrgfilename()}"> <input type="hidden"
		...
		<tr>
			...
			<td>
				<div class="form-group">
 				 <textarea class="form-control" rows="3"  id="contents" name="contents">${vo.getContent()}</textarea>
				</div>
			</td>
		</tr>
		<tr>
			<td colspan="2"><c:if test="${vo eq null}">
				...
				</c:if> <input type="button" value="취소" onclick="javascript:history(-1)">
			</td>
		</tr>
	</table>
</form>