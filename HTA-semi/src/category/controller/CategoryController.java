...
public class CategoryController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if (!mod.equals("") && mod.equals("list")) {
			...
			nameCk(req, res);
		} else if (!mod.equals("") && mod.equals("getCate")) {// 중복 카테고리 체크
			leftList(req, res);
		}

	}

	private void leftList(HttpServletRequest req, HttpServletResponse res)
		...
		req.getRequestDispatcher("/layout.jsp?page="+page).forward(req, res);
	}
